...
const InfoCard = (props) => {
    ...
    return (
        <div className="FoodysParadise mt-10 flex justify-center">
            <a href={assetlink[0]} onClick={() => { if (assetlink.length > 1) { window.open(assetlink[1]);}}} target="_blank" rel="noopener noreferrer">
                <div className="imgs relative">
                    <img src={image1} alt="" className="relative z-10 w-1/50 lg:w-1/25" />
